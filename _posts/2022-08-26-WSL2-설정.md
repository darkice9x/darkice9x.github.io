...
3. Windows 하이퍼바이저 플랫폼과 가상 머신 플랫폼 체크
      ...
      ![image](/assets/images/wsl2/Image_005.png){: width="100%" height="100%"}
...
6. LibreOffice 설치
    ...
    $ libreoffice --version
    ~~~
  ![image](/assets/images/wsl2/Image_007.png){: width="100%" height="100%"}
...
3. USB 디바이스 연결
  ...
  * 관리자 모드에서 PowerShell을 열고 명령을 입력하여 Windows 연결된 모든 USB 디바이스를 나열합니다.
    ...
    usbipd wsl list
  ![image](/assets/images/wsl2/Image_008.png){: width="100%" height="100%"}
  ...
  * Ubuntu(또는 원하는 WSL 명령줄)를 열고 다음 명령을 사용하여 연결된 USB 디바이스를 나열합니다.
      ...
      $ lsusb
  ![image](/assets/images/wsl2/Image_009.png){: width="100%" height="100%"}

      $ dmesg | grep tty
  ![image](/assets/images/wsl2/Image_010.png){: width="100%" height="100%"}

      $ minicom -s
  ![image](/assets/images/wsl2/Image_011.png){: width="100%" height="100%"}

      Port를 /dev/ttyUSB0선택
  ![image](/assets/images/wsl2/Image_012.png){: width="100%" height="100%"}
