...
<table border="1">
    <tr>
        <td>
            <img src="https://github.com/darkice9x/PaddleOCRV5_Korean/blob/main/hangul.png" width="75%">
        </td>
        <td>
            <img src="https://github.com/darkice9x/PaddleOCRV5_Korean/blob/main/korean.png" width="100%">
        </td>
    </tr>
</table>
